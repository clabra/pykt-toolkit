#!/usr/bin/env python
"""
Compute skill-specific, time-varying Rasch calibration for TEST data.
...
Output: rasch_per_skill_targets_test.pkl with:
...
Usage:
    python examples/compute_rasch_per_skill_test.py --dataset assist2015 --seed 42
"""
...
def load_dataset_sequences(dataset_name, data_dir='data'):
    ...
    # Load sequences from CSV - using TEST data
    dataset_path = os.path.join(data_dir, dataset_name, "test_sequences.csv")
...
def main():
    ...
    parser.add_argument('--output_path', type=str, default=None,
                        help='Output path (default: data/{dataset}/rasch_per_skill_targets_test.pkl)')
    ...
    if args.output_path is None:
        args.output_path = os.path.join(
            args.data_dir, args.dataset, 'rasch_per_skill_targets_test.pkl'
        )
