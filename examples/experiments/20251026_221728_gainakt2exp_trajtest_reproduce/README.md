# Experiment 20251026_221728_gainakt2exp_trajtest_reproduce (Repro Mode)
...
```json
{
  "training": {
    ...
    "use_wandb": false,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251026_221728_gainakt2exp_trajtest_reproduce"
  },
  "constraints": {
