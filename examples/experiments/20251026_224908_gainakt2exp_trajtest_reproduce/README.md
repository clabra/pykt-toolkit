# Experiment 20251026_224908_gainakt2exp_trajtest_reproduce (Repro Mode)
...
```json
{
  "training": {
    ...
    "use_wandb": false,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251026_224908_gainakt2exp_trajtest_reproduce"
  },
  "constraints": {
...
Error: target results.json missing: /workspaces/pykt-toolkit/examples/experiments/20251026_224908_gainakt2exp_trajtest_reproduce/results.json
...
## Compare-Only Results
Error: target results artifacts missing in /workspaces/pykt-toolkit/examples/experiments/20251026_224908_gainakt2exp_trajtest_reproduce
