# Experiment 20251026_231636_gainakt2exp_trajtest (Repro Mode)
...
```json
{
  "training": {
    ...
    "use_wandb": false,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251026_231636_gainakt2exp_trajtest"
  },
  "constraints": {
