# Experiment 20251026_233234_gainakt2exp_override_demo (Repro Mode)
...
```json
{
  "training": {
    ...
    "use_wandb": false,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251026_233234_gainakt2exp_override_demo"
  },
  "constraints": {
