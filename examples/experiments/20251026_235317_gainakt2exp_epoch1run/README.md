# Experiment 20251026_235317_gainakt2exp_epoch1run (Repro Mode)
...
```json
{
  "training": {
    ...
    "use_wandb": false,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251026_235317_gainakt2exp_epoch1run"
  },
  "constraints": {
