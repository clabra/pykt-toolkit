# Experiment 20251026_235428_gainakt2exp_epoch1run_reproduce (Repro Mode)
...
```json
{
  "training": {
    ...
    "use_wandb": false,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251026_235428_gainakt2exp_epoch1run_reproduce"
  },
  "constraints": {
