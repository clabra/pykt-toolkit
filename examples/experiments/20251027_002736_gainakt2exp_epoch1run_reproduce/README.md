# Experiment 20251027_002736_gainakt2exp_epoch1run_reproduce (Repro Mode)
...
```json
{
  "training": {
    ...
    "use_wandb": false,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251027_002736_gainakt2exp_epoch1run_reproduce"
  },
  "constraints": {
