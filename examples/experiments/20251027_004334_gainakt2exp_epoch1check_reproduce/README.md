# Experiment 20251027_004334_gainakt2exp_epoch1check_reproduce (Repro Mode)
...
```json
{
  "training": {
    ...
    "use_wandb": false,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251027_004334_gainakt2exp_epoch1check_reproduce"
  },
  "constraints": {
