# Experiment 20251027_004535_gainakt2exp_epoch1check_reproduce (Repro Mode)
...
```json
{
  "training": {
    ...
    "seed": 42,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251027_004535_gainakt2exp_epoch1check_reproduce",
    "optimizer": "Adam",
