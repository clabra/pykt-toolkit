# Experiment 20251027_005018_gainakt2exp_epoch1fresh (Repro Mode)
...
```json
{
  "training": {
    ...
    "use_wandb": false,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251027_005018_gainakt2exp_epoch1fresh"
  },
  "constraints": {
