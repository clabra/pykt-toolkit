# Experiment 20251027_005120_gainakt2exp_epoch1fresh_reproduce (Repro Mode)
...
```json
{
  "training": {
    ...
    "seed": 42,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251027_005120_gainakt2exp_epoch1fresh_reproduce",
    "optimizer": "Adam",
