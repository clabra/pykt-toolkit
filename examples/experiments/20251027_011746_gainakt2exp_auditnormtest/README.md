# Experiment 20251027_011746_gainakt2exp_auditnormtest (Repro Mode)
...
```json
{
  "training": {
    ...
    "use_wandb": false,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251027_011746_gainakt2exp_auditnormtest"
  },
  "constraints": {
