# Experiment 20251027_012816_gainakt2exp_auditnormtest2_reproduce (Repro Mode)
...
```json
{
  "training": {
    ...
    "seed": 42,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251027_012816_gainakt2exp_auditnormtest2_reproduce",
    "optimizer": "Adam",
