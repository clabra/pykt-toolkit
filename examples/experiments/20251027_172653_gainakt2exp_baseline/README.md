# Experiment 20251027_172653_gainakt2exp_baseline (Repro Mode)
...
```json
{
  "training": {
    ...
    "use_wandb": false,
    "output_dir": "/workspaces/pykt-toolkit/examples/experiments/20251027_172653_gainakt2exp_baseline"
  },
  "constraints": {
