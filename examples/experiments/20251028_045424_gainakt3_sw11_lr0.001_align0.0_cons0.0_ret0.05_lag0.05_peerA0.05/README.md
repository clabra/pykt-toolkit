# Experiment 20251028_045424_gainakt3_sw11_lr0.001_align0.0_cons0.0_ret0.05_lag0.05_peerA0.05

GainAKT3 training on real dataset split (assist2015) with masked losses.

## Summary
Best epoch: 2 val_auc=0.6818 val_acc=0.7450 mastery_corr=0.1130 gain_corr=0.0081 mastery_corr_macro=0.6536 gain_corr_macro=-0.0006

## Interpretability Metrics (best epoch)
| Metric | Value |
|--------|-------|
| Mastery Correlation (global) | 0.1130 |
| Gain Correlation (global) | 0.0081 |
...
| Gain Future Alignment | 0.0018 |
| Peer Influence Share | 0.2178 |
