# Experiment 20251030_171930_gainakt2exp_test_default_values

Model: gainakt2exp
Short title: test_default_values
...
| Key | Value |
|-----|-------|
| interpretability.use_mastery_head | False |
| interpretability.use_gain_head | False |
...
| interpretability.warmup_constraint_epochs | 4 |
| interpretability.non_negative_loss_weight | 0.0 |
| interpretability.enhanced_constraints | False |
...
|--------|-------|
| best_epoch | 12.0 |
| best_val_auc | 0.6197195908496643 |
| best_val_accuracy | 0.710177228002219 |
| mastery_corr | None |
| gain_corr | None |
