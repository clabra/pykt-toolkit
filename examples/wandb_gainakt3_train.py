#!/usr/bin/env python3
"""
Enhanced GainAKT3 Training with Detailed Epoch AUC Feedback

This script provides comprehensive epoch-by-epoch AUC reporting for better monitoring
during parameter sweeps. Based on the original wandb_GainAKT3_train.py but with
...
def main(params):
    ...
    logger.info("ENHANCED GainAKT3 Training with Detailed AUC Feedback")
    logger.info("=" * 70)
...
def main_wrapper():
    ...
    parser = argparse.ArgumentParser(description='Enhanced GainAKT3 Training')
    ...
    parser.add_argument('--model_name', type=str, default='GainAKT3', help='Model name')
    ...
    print("\nEnhanced GainAKT3 Training Configuration")
    print("=" * 60)
