...
# Dataset: assist2015
# Seed: 42
# Benchmark results: /workspaces/pykt-toolkit/experiments/20251208_190103_benchmark_assist2015/results.csv
#
# This script evaluates all successfully trained models on test data.
# Run manually after all training completes:
#   bash /workspaces/pykt-toolkit/experiments/20251208_190103_benchmark_assist2015/evaluate.sh
#
