...
# Dataset: assist2009
# Seed: 42
# Benchmark results: /workspaces/pykt-toolkit/experiments/20251208_225023_benchmark_assist2009/results.csv
#
# This script evaluates all successfully trained models on test data.
# Run manually after all training completes:
#   bash /workspaces/pykt-toolkit/experiments/20251208_225023_benchmark_assist2009/evaluate.sh
#
...
python wandb_predict.py \
    --save_dir saved_model/assist2009_akt_qid_saved_model_42_0_0.2_256_512_8_4_0.0001_0_0 \
    --use_wandb 0 \
    --bz 256
