...
\begin{minipage}{0.48\textwidth}
    ...
    \caption*{ (a) ASSISTments 2009}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{img/volume_as2015.png}
    \caption*{ (b) ASSISTments 2015}
\end{minipage}
\caption{Delta distributions showing student learning rate deviations from the baseline. \label{fig_delta}}
\end{figure}

\subsubsection{Individualized Adaptive Pacing} \label{sec_longitudinal}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\textwidth]{img/mosaic_as2009.png}
\caption{Mastery alignment across different skills in ASSISTments 2009. Solid lines illustrate individualized iDKT trajectories for students categorized by high (green), medium (yellow), and low (red) learning rates, while dashed lines represent the population-level BKT priors. \label{fig_mosaics}}
\end{figure}

\subsubsection{Mastery Estimations Confidence} \label{sec_confidence}
...
The high density of high-correlation cells demonstrates that Representational Grounding successfully anchors iDKT's performance estimates across the majority of the curriculum, particularly where student evidence is most abundant.
...
\begin{figure}[htbp]
    ...
    \end{minipage}
    \caption{ASSISTments 2015 (top) and 2009 (bottom) heatmaps of per-skill prediction alignment. \label{fig_heatmaps}}
\end{figure}
