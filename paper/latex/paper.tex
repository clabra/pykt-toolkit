...
\added{Future research will aim to extend the empirical validation of \textit{gTransformer} beyond the benchmark datasets utilised in this study. Although the underlying methodology is fundamentally domain-independent, extending this evaluation to a wider range of datasets across varied domains and subjects represents a valuable research direction to further demonstrate the model's versatility.}
