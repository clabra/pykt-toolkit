...
\begin{tabular}{lcc}
\toprule
\textbf{Parameter} & \textbf{Spearman $\rho$ (H2.2)} & \textbf{Interpretation} \\
\midrule
...
These findings support H2.2, confirming that grounded parameters maintain moderate-to-strong monotonic alignment with pedagogical theory while capturing individual behavioral heterogeneity.
