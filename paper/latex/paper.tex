...
The remainder of this paper is structured as follows. Section~\ref{sec_related} reviews the current state of deep knowledge tracing and interpretability. Section~\ref{sec_method} describes the proposed iDKT architecture and the Representational Grounding framework. Section~\ref{sec_results} presents the experimental validation and answers the research questions. Finally, Section~\ref{sec_conclusions} provides the concluding remarks.
...
\subsection{The Tradeoff Interpretability vs Prediction Accuracy}
...
\item
  \textbf{Support}: This follows the \textbf{Representational Grounding}
...
sweep. This confirms that the Representational Grounding mechanism
