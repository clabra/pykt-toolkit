...
We present iDKT, a deep learning model based on an encoder-decoder Transformer architecture \citep{vaswani2017attention} extended with specialized components designed to achieve Semantic Interpretability. Within the framework of explainability techniques for Knowledge Tracing proposed by \citet{bai2024survey}, our proposal represents an ante-hoc approach that provides model-intrinsic interpretability through the integration of attention mechanisms. However, unlike existing methods in this category that primarily target deep learning specialists, iDKT is specifically oriented toward domain experts by providing estimations grounded in educational theory.

The integration of domain knowledge into deep learning has been broadly explored through frameworks such as theory-guided data science \citep{karpatne2017theory}, physics-informed machine learning \citep{karniadakis2021physics}, and informed machine learning \citep{vonrueden2021informed}. iDKT operationalizes these principles within the field of Knowledge Tracing by utilizing the taxonomic dimensions of information flow characterized by \citet{vonrueden2021informed}. As depicted in Figure~\ref{fig_info_flow}, our approach leverages pedagogical theory as a systematic source of information that guides both the representational space (via grounding) and the optimization process (via multi-objective losses).

\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{img/iml.png}
    \caption{Information Flow in iDKT, following the taxonomy proposed by \citet{vonrueden2021informed}.}
    \label{fig_info_flow}
\end{figure}
