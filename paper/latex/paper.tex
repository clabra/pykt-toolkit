...
\definechangesauthor[name=Reviewer, color=violet]{rev3com1}
...
$d_{\text{model}}$ & 64 & 64 \\
\replaced[id=rev3com1]{$n_{\text{blocks}}$ (Encoder / Decoder)}{$n_{\text{blocks}}$} & 4 / 8 & 4 / 8 \\
\added[id=rev3com1]{Total attention layers} & \added[id=rev3com1]{12} & \added[id=rev3com1]{12} \\
$d_{\text{ff}}$ & 256 & 256 \\
Attention heads & 4 & \makecell{AS2009: 8\\others: 4} \\
\added[id=rev3com1]{Output MLP dimensions} & \added[id=rev3com1]{[128, 512, 256, 1]} & \added[id=rev3com1]{[128, 512, 256, 1]} \\
\added[id=rev3com1]{Activation function} & \added[id=rev3com1]{\texttt{ReLU}} & \added[id=rev3com1]{\texttt{ReLU}} \\
\added[id=rev3com1]{Normalization} & \added[id=rev3com1]{\textit{LayerNorm}} & \added[id=rev3com1]{\textit{LayerNorm}} \\
\midrule
...
Epochs & 200 & 200 \\
\replaced[id=rev3com1]{Dropout ($p$)}{Dropout} & 0.1 & 0.1 \\
\added[id=rev3com1]{Weight initialization} & \makecell{\added[id=rev3com1]{Xavier /} \\ \added[id=rev3com1]{Orthogonal}} & \makecell{\added[id=rev3com1]{Xavier /} \\ \added[id=rev3com1]{Orthogonal}} \\
\bottomrule
\end{tabular}
