...
The model is trained using a theoretically-anchored total loss $\mathcal{L}_{total}$, ensuring that the high-capacity Transformer remains aligned with pedagogical principles:
\begin{equation}
