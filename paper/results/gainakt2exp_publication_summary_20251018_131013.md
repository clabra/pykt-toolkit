...
Generated: 2025-10-18T13:10:13.942150
## Aggregate Metrics
...
|---------|-------|----------|---------|------------|-------------|-------------------|--------------|-----------|------------|----------|-------------|
| full | 1 | 0.6754 | 0.0000 | 0.6754 | 0.6754 | +0.0000 | 0.043 | 0.002 | 0.00% | 0.00% | 0.00% |

## Success Criteria Evaluation
| Criterion | Value | Pass |
|-----------|-------|------|
| Predictive Parity ΔAUC (Full-HeadsOff) | +0.0000 | None |
| Stability Std(AUC) (Heads-Off) | nan | None |
| Architecture-Only ΔAUC vs Heads-Off | +0.0000 | n/a |
| Constraints Incremental ΔAUC (Full-ArchOnly) | +0.0000 | n/a |
