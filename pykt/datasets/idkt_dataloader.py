...
class IDKTDataset(KTDataset):
    ...
    def __load_data__(self, sequence_path, folds, pad_val=-1):
        ...
        # Create a deterministic, dense UID-to-index mapping
        # Sort UIDs to ensure consistent ordering across runs and folds
        ...
        for i, row in df.iterrows():
            ...
            # Use mapped index (not raw UID) for embedding layer
