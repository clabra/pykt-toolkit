...
def create_exp_model(config):
    ...
    return GainAKT2Exp(
        ...
        use_learnable_threshold=config.get('use_learnable_threshold', False),
        threshold_temperature=config.get('threshold_temperature', 0.1),
        threshold_loss_weight=config.get('threshold_loss_weight', 0.5),
