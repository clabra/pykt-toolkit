"""
iDKT (Interpretable Deep Knowledge Tracing) Model

Initial version: Direct copy of AKT model for baseline establishment.
Future versions will introduce interpretability enhancements.
