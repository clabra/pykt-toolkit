"""
iKTMon: iKT with Training-Time Interpretability Monitoring

Extends iKT with monitoring hooks for real-time interpretability analysis.
"""
...
class iKTMon(iKT):
    ...
    def __init__(self, num_c, seq_len, d_model=256, n_heads=4, num_encoder_blocks=4,
                 ...
                 epsilon=0.0, phase=1, monitor_frequency=50):
        super().__init__(
            num_c=num_c,
            seq_len=seq_len,
            d_model=d_model,
    ...
    def forward_with_states(self, q, r, qry=None, rasch_targets=None):
        """
        ...
        """
        # Run base forward
        output = self.forward(q, r, qry, rasch_targets)
...
def create_mon_model(config):
    """
    Factory function to create iKTMon model.
